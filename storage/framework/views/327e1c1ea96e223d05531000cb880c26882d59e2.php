            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="image-container">
                        <img class="img-fluid" src="<?php echo e(asset('images/image33.jpg')); ?>" alt="alternative" >
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="section1-container-fluid px-0">
                    <img class="img-fluid" src="<?php echo e(asset('images/camera.png')); ?>" alt="alternative">
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="mycontainer-container-fluid">
                <img class="img-fluid" src="<?php echo e(asset('images/cctv8.png')); ?>" alt="alternative">
        ...
        <div class="col-lg-6">
            <div class="mycontainer1-container-fluid px-0">
                <h5 class="text1">Why Choose Us ?</h5>
                    <ul id="serviceid">
                        <li><span><img src="<?php echo e(asset('images/cctv27.png')); ?>">Highly experienced team to guide & assist your requirements. No high pressure sales</span></li>
                        <li><span><img src="<?php echo e(asset('images/cctv28.png')); ?>"></span>Our surveyor will visit your premises and discuss your needs</li>
                        <li><span><img src="<?php echo e(asset('images/cctv29.png')); ?>"></span>Latest equipment to protect your property</li>
                        <li><span><img src="<?php echo e(asset('images/cctv30.png')); ?>"></span>Full installation & maintenance service from our own engineers</li>
                    </ul>   
            </div> <!-- end of text2-container -->
        </div> <!-- end of col -->
    </div> <!-- end of row -->
        ...
        <h5 class="section-title">Our Offerings</h5>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <!-- Card -->
                        <div class="card">
                            <img class="card-image-top" src="<?php echo e(asset('images/imag2.jpg')); ?>" alt="alternative" style="height:50%;">
                    ...
                    <!-- Card -->
                        <div class="card">
                            <img class="card-image-top" src="<?php echo e(asset('images/cctv camera repair.jpg')); ?>" alt="alternative" style="height:50%">
                            <div class="card-body p-2 my-4">
                    ...
                    <!-- Card -->
                        <div class="card">
                            <img class="card-image-top" src="<?php echo e(asset('images/survillence.jpg')); ?>" alt="alternative">
                            <div class="card-body p-2 my-4">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <!-- Card -->
                        <div class="card">
                            <img class="card-image-top" src="<?php echo e(asset('images/image32.jpg')); ?>" alt="alternative">
                            <div class="card-body p-2 my-4">
                    ...
                    <!-- Card -->
                        <div class="card">
                                <img class="card-image-top" src="<?php echo e(asset('images/image30.jpg')); ?>" alt="alternative" style="max-height:50%;">
                                <div class="card-body p-2 my-4">
                    ...
                    <!-- Card -->
                        <div class="card">
                            <img class="card-image-top" src="<?php echo e(asset('images/image31.jpg')); ?>" alt="alternative">
                            <div class="card-body p-2 my-4">
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="img-container">
                <img class="img-fluid" src="<?php echo e(asset('images/house1.png')); ?>" alt="alternative">
            </div> <!-- end of image-container -->
        </div> <!-- end of col -->
...
<?php echo $__env->make('upper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\anchal\Desktop\laravel\cctv\resources\views/welcome.blade.php ENDPATH**/ ?>